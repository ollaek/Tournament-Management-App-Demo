...
namespace BackEnd
{
    ...
    {
        public ApplicationSignInManager(AdminManager userManager, IAuthenticationManager authenticationManager)
        ...
        {
            return new ApplicationSignInManager(context.GetUserManager<AdminManager>(), context.Authentication);
        }
    }
}
